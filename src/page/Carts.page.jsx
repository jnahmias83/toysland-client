                  ...
                  {cartsData.map((cartItem) => (
                    <>
                      <tr key={cartItem._id} style={{ alignItems: "center" }}>
                        ...
                        <td>{cartItem.toy.name}</td>
                        <td>{cartItem.toy.description}</td>
                        <td>{cartItem.toy.category}</td>
                        <td>{cartItem.toy.price}</td>
                        <td>{cartItem.quantity}</td>
                        <td>{cartItem.toy.price * cartItem.quantity}</td>
                        <td>
                          <a
                            onClick={() => {
